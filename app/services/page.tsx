        ...
        <>
            <section className="section" style={{ paddingTop: '150px', paddingBottom: '50px' }}>
                <div className="container" style={{ textAlign: 'center' }}>
                    ...
                    >
                        {content.servicesPage.intro.title} <span style={{ color: 'var(--accent-cyan)' }}>{content.servicesPage.intro.titleAccent}</span>
                    </motion.h1>
                    <motion.p
                    ...
                    >
                        {content.servicesPage.intro.description}
                    </motion.p>
                </div>
            </section>
            ...
            <section className="section">
                <div className="container">
                    {content.servicesPage.sections.map((section, index) => (
                        <motion.div
                            key={index}
                            className={`glass-card grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12`}
                            initial={{ opacity: 0, y: 30 }}
                        ...
                        >
                            <div className={`order-2 ${index % 2 === 1 ? 'md:order-1' : ''}`} style={{ height: '300px', background: `${section.accentColor}0d`, borderRadius: '20px', border: `1px solid ${section.accentColor}33`, overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                {/* Using 0d for ~5% opacity and 33 for ~20% opacity hex codes roughly */}
